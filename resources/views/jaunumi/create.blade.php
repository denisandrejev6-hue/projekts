...
@section('content')
    ...
    <form action="{{ route('jaunumi.store') }}" method="POST" enctype="multipart/form-data" style="max-width:600px;">
        ...
        <div class="form-control" style="margin-bottom:16px;">
            ...
            <input type="text" name="publicets_datums" value="{{ old('publicets_datums') }}" data-picker="date" placeholder="dd.mm.gggg" autocomplete="off" style="width:100%; padding:10px; border-radius:6px;">
        </div>
        ...
        <div style="display:flex; gap:12px;">
            ...
            <a href="{{ route('jaunumi.index') }}" class="btn secondary btn-cancel">Atcelt</a>
        </div>
    </form>
@endsection

    ...
    <form action="{{ route('pasakumi.store') }}" method="POST" class="pasakumi-form" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="datums_no" value="{{ old('datums_no') }}" data-picker="date" placeholder="dd.mm.gggg" autocomplete="off"
            ...
            <div class="form-group">
                ...
                <input type="text" name="datums_lidz" value="{{ old('datums_lidz') }}" data-picker="date" placeholder="dd.mm.gggg" autocomplete="off"
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="sakuma_laiks" value="{{ old('sakuma_laiks') }}" data-picker="time" placeholder="hh:mm" autocomplete="off"
            ...
            <div class="form-group">
                ...
                <input type="text" name="beigu_laiks" value="{{ old('beigu_laiks') }}" data-picker="time" placeholder="hh:mm" autocomplete="off"
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="registracijas_beigu_datums" value="{{ old('registracijas_beigu_datums') }}" data-picker="date" placeholder="dd.mm.gggg" autocomplete="off"
            ...
            <div class="form-group">
                ...
                <input type="text" name="registracijas_beigu_laiks" value="{{ old('registracijas_beigu_laiks') }}" data-picker="time" placeholder="hh:mm" autocomplete="off"
